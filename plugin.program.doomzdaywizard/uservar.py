...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = base64.b64decode(b'W0JdW0NPTE9SIEdvbGRdRG9vbXpkYXlbL0NPTE9SXVsvQl0gV2l6YXJk')
...
THEME1 = '[COLOR '+COLOR1+'][I]([COLOR '+COLOR1+'][B]Doomzday[/B][/COLOR][COLOR ' + COLOR2 + ']Wizard[COLOR ' + COLOR1 + '])[/I][/COLOR] [COLOR '+COLOR2+']{0}[/COLOR]'
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Doomzday Wizard'
...
# Font size of header
FONTHEADER = 'Font13'
HEADERMESSAGE = base64.b64decode(b'W0NPTE9SIHJlZF1bQl1Eb29temRheSBXaXphcmRbL0JdWy9DT0xPUl0=')
